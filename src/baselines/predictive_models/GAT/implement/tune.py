...
from GAT_codes.utils import CustomDataset, get_graph_from_smile
from GAT_codes.layers.mpnn_layer import GAT
import warnings
...
def train(
        ...
        model_save_path: str = 'experiments/GAT',
    ...
    print('Create model')
    model = GAT(node_input_dim=51, edge_input_dim=10)
...
def predict(
        smis,
        model_path: str = 'experiments/gat',
