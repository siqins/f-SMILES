...
class PredictionArgs(argparse.ArgumentParser):
    def __init__(
        ...
        self.add_argument("--max-nodes", default=13, type=str)
        self.add_argument("--return-adj", default=False, type=bool)
        # task param
        self.add_argument(
            "--target_features",
            # default="HOMO-LUMO gap/eV,HOMO,electron_affinity e/V,ionization e/V,"
            # "reorganisation energy eV,oxidation potential eV",
            default="PCE-D18-IC_DH,PCE-D18-IC2F_OB,PCE-D18-IC2Cl_HE",
            type=str,
        ...
        # Model parameters
        self.add_argument("--dp", type=eval, default=False, help="Data parallelism")
