...
class MolecularVAE(nn.Module):
    def __init__(self, vocab_size=38, len_seq=140):
    ...
    def decode(self, z):
        z = F.selu(self.fc2(z))
        z = z.view(z.size(0), 1, z.size(-1)).repeat(1, self.len_seq, 1)
        out, h = self.gru(z)
